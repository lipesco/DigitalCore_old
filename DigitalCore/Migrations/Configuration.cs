    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DigitalCoreDb>
    {
        ...
        protected override void Seed(DigitalCoreDb context)
        {
            ...
            var produto = new List<Produto> {
                new Produto {ID=1, numeroSerie=123456789, TipoFK=1, descricao="HP Omen 880-106Np", caracteristicas="Processador Intel i7 8700, RAM 16GB", preco="€1200", imagem="computador01.jpg" },
                new Produto {ID=2, numeroSerie=123456790, TipoFK=5, descricao="Toshiba TR200 3D TLC SATA III", caracteristicas="Disco SSD 240GB", preco="€55", imagem="discossd01.jpg" },
                new Produto {ID=3, numeroSerie=123456791, TipoFK=1, descricao="Asus ROG GR8II-T022Z Auta", caracteristicas="Processador Intel i5 7400, RAM 9GB", preco="€950", imagem="computador02.jpg" },
                new Produto {ID=4, numeroSerie=123456792, TipoFK=1, descricao="Asus D320MT", caracteristicas="Processador Intel i7 7700, RAM 8GB", preco="€600", imagem="computador03.jpg" },
                new Produto {ID=5, numeroSerie=123456793, TipoFK=5, descricao="Samsung 500GB EVO 850", caracteristicas="Disco SSD 500GB", preco="€125", imagem="discossd02.jpg" },
                new Produto {ID=6, numeroSerie=123456794, TipoFK=5, descricao="Kingston 120GB SSD A400 SATA III", caracteristicas="Disco SSD 120GB", preco="€35", imagem="discossd03.jpg" },
                new Produto {ID=7, numeroSerie=123456795, TipoFK=3, descricao="HP 15-bs109np", caracteristicas="Processador Intel i5 8250U, RAM 8GB, Disco 1TB", preco="€550", imagem="portatil01.jpg" },
                new Produto {ID=8, numeroSerie=123456796, TipoFK=3, descricao="Asus Zenbook UX430UA-78DHDCB1", caracteristicas="Processador Intel i7-8550U, 16GB RAM, Disco SSD 512GB", preco="€55", imagem="portatil02.jpg" }
